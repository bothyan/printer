<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-input @keyup.enter.native="handleFilter" style="width: 150px;" class="filter-item" :placeholder="$t('table.stationsNum')" v-model="listQuery.stationsNum">
      </el-input>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      ...
      <el-table-column min-width="150px" align="center" :label="$t('table.stationsNum')">
        <template slot-scope="scope">
          <span>{{scope.row.stationsNum}}</span>
        </template>
      </el-table-column>
...
<script>
import { produceLogList  } from '@/api/logs'
...
export default {
  ...
  methods: {
    getList() {
      ...
      produceLogList(this.listQuery).then(response => {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['timestamp', 'name', 'stationsNum']
        const filterVal = ['timestamp', 'name', 'stationsNum']
